...
public class SpringInitializrController {
	...
	public ResponseEntity<FileSystemResource> generateProject(@RequestParam String dependencies,
															  ...
															  ,@RequestParam (required = false)String TMFStandard,
															  @RequestParam String dbConfig){
		try {
			springInitializrService.generateProject(dependencies, type, language, javaVersion,TMFStandard,dbConfig);
