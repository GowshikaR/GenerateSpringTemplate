...
public class OrganizationService {
    ...
    @Value("${tmf632.organization.get-all}")
    private String getAllUrl;
    

    @Value("${tmf632.organization.get-by-id}")
    private String getByIdUrl;


    @Value("${tmf632.organization.create}")
    private String createUrl;


    @Value("${tmf632.organization.patch}")
    private String updateUrl;


    @Value("${tmf632.organization.delete}")
